            ...
            <aside class="md:w-1/3 lg:w-1/4 md:h-screen md:sticky top-0 p-8 bg-gray-100 dark:bg-base-200 shadow-lg transition-colors duration-300 md:overflow-y-auto">
                <div class="flex flex-col items-center md:items-start space-y-6">
                    ...
                    <div class="flex flex-col justify-center md:justify-start gap-y-3">
                        ...
                        <a href="https://scholar.google.com/citations?user=yPCnO74AAAAJ" target="_blank" rel="noopener noreferrer" title="Google Scholar" class="inline-flex items-center gap-2 text-gray-500 dark:text-gray-400 hover:text-accent-light dark:hover:text-accent transition-colors duration-300">
